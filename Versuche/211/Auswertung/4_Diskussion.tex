...
In der letzten \csec{A3} wurde die Kopplung numerisch bestimmt. Aus den Kopplungen wiederrum konnten die Verhältnisse bestimmt werden, ebenso wie die Verhältnisse der quadrierten Aufhängungsabstände. Es kommte festgestellt werden, dass die Verhältnisse statistisch dasselbe aussagen, nur ein Wert ist grenzwertig nicht signifikant.
