...
Im letzten Teil des Versuchs wird ein System aus zwei induktiv gekoppelten elektrischen Schwingkreisen untersucht. Durch Variation des Abstands der Spulen wird die Kopplungsstärke verändert. Die Spannungsverläufe beider Kreise werden mit einem Oszilloskop beobachtet, wobei insbesondere das Auftreten von Schwebungen qualitativ analysiert wird.

\img[0.5]{sym/FFT-batch_Page_1}{Beispielhafte Gaußkurve}
\img[0.5]{sym/Symmetrisch_S2-Mittel_Signale}{Beispielhaftes Gemessenes Signal}


% \img[0.4]{memes/bLatex}{Ja Dimitrij, ich kenne dich...}\footnote{Ein Latex-Meme darf sein :)}

\img{Versuchsaufbau_bes}{Bild des Versuchsaufbau mit Beschriftungen}