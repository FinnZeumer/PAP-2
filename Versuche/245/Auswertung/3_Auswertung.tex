...
Daten aus \hyperref[ch:Protokoll]{Messprotokoll} Tabelle 2.1 und 2.2

Frequenzen in Kreisfrequenzen umgerechnet
\eq{frqToKreisfreq}{
    \omega = 2\pi f
}

Spannungen in Spitze spitze gemessen, daher mit 2 dividiert.
