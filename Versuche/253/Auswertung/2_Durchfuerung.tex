...
\iimg[0.61]{plt1}{plt2}{(a) Zeigt die Reichweite von $\beta$-Strahlung in Aluminum und von $\alpha$-Strahlung in Luft. (b) zeigt den auf die Masse normierten Wirkungsquerschnitt von Photonen in Blei und Aluminum in der Abhänigkeit der Photonenenergie. \cite{skriptPAP22}. Eingezeichnete Werte sind dem \cch{Anhang} zu entnehmen.}
