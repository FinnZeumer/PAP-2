...
Der Versuch hat Spaß gemacht. Die Durchführung ging schnell und es wurden schöne Bilder verwendet. Leider wurde im Skript \afz{Rüchardt} falsch geschrieben und zwar \afz{Rüchhardt}, was viel cooler wäre aber leider falsch ist. Das hat mich etwas traurig gemacht, da es jetzt auch fashc im \hyperref[ch:protokoll]{Messprotokoll (\ref*{ch:protokoll})} steht.