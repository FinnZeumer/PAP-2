...
\img[0.5]{CuD-pV}{pV-Diagramm des Kreisprozesses nach Clément und Desormes.}
...
Bestimmt. Über die Periodendauer \(T = 2\pi / \omega\) folgt
\eq{R_T}{
...
\img[0.3]{Tabelle-Wichtige-Kappa}{Typische Werte für den Adiabatenkoeffizienten \(\kappa\) verschiedener Gase. Dies sind zugleich die Literaturwerte, die Später für die Rechnung genutzt werden sollen.}