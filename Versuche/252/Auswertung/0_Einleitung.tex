...
\img{Nuklioide}{Ausschnitt der Nuklidkarte mit den Halbwertszeiten und der Energie der emittierten Strahlung\cite{skriptPAP22}. Diese Werte werden für die Indiumauswertung genutzt, da hier der angeregte Zustand vermerkt ist.}

\img[1]{NuDat_Nukleoide}{Ausschnitt Nuklidkarte nach NuDat (https://www.nndc.bnl.gov/nudat3/). Diese Werte werden für dei Silberauswertung genutzt, da diese präziser sind.}