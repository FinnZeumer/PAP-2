...
Um stabiles Indium zu aktivieren, wird es analog bestreut. Durch die Bestrahlung kommen zur Bildung zweier Isomere eines radioaktiven Indiumisotops. Zum einen entsteht das Isotop $^{116}\mathrm{In}$, welches sich im energetischen Grundzustand befindet, zum anderen $^{115\mathrm{m}}\mathrm{In}$, welches sich im metastabilen Zustand befindet. Beide Isotope sind $\beta$-Strahler, zeigen aber unterschiedliche Halbwertszeiten. Beide Isotope des Indiums zerfallen zu $^{116}\mathrm{Sn}$ (Zinn).
...
\img{NuDat_Nukleoide}{Ausschnitt Nuklidkarte nach NuDat (https://www.nndc.bnl.gov/nudat3/)}