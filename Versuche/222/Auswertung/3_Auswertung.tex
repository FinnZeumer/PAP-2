...
\eq{err_func_wirkungsgrad_hier_der}{
    \Delta \eta_\text{Last} = \eta_\text{Last} \, \sqrt{\frac{\Delta {Q_\text{el}}^{2}}{{Q_\text{el}}^{2}} + \frac{\Delta {W_\text{pV}}^{2}}{{W_\text{pV}}^{2}}}  \, ,
}


\eq{err_func_eta_efffffff}{
    \Delta \eta_\text{eff} = \eta_\text{eff} \, \sqrt{\frac{\Delta {Q_\text{el}}^{2}}{{Q_\text{el}}^{2}} + \frac{\Delta {W_\text{D}}^{2}}{{W_\text{D}}^{2}}}  \, ,
}
...
\begin{table}
    ...
    \begin{tabular}{C | C C C C || C C}
        \toprule
        F \, [\mathrm{N}] & f \, [\mathrm{Hz}] & W_\mathrm{pV} \, [\mathrm{J}] & Q_\mathrm{el} \, [\mathrm{J}] & W_\mathrm{D} \, [\mathrm{J}] & \eta \, [\%] & \eta_\mathrm{eff} \, [\%]\\
        \midrule
...
\img[1]{Wirkungsgrade}{Wirkungsgrade in Abhänigkeit der Frequenz.}