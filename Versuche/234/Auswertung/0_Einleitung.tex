...
beschreiben, wobei $E_\mathrm{Ry}$ die Rydbergenergie und $\delta_l$ der l-abhängige Korrekturterm ist. Dieser Term berücksichtigt die Abweichung vom reinen Wasserstoffpotential und hängt hauptsächlich vom Drehimpulsquantenzahl $l$ ab. Daher wird die Hauptquantenzahl $n$ in dieser Auswertung nicht konkret berücksichtigt. Sein Wert wird für alle Analysen auf $n=3$ gesetzt.
