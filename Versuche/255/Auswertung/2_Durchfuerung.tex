...
\img{Example_Graph}{Example of a X-Ray spectrum. \cite{skriptPAP22}}
...
\img{Versuchsaufbau}{Schematic setup of the X-ray spectrometer following the rotating crystal method.}