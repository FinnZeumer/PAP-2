...
Darüber hinaus wird die Dämpfung des Kreisels untersucht, da Reibungsverluste die Eigenrotation beeinflussen und somit in allen Auswertungen berücksichtigt werden müssen.  
Der Versuch ermöglicht ein vertieftes Verständnis der Dynamik starrer Körper und liefert gleichzeitig eine grundlegendes Verständnis für zahlreiche technische Anwendungen, etwa in Navigationssystemen oder der Stabilisierung von Satelliten.
...
wobei $l$ der Abstand der Zusatzmasse vom Auflagepunkt ist und $g$ die Erdbeschleunigung.
...
Für die im Versuch definierten Achsen, kann man unter Kenntnis der Figurenfrequenz $\omega_F$, der Winkelgeschwindigkeit $\Omega$ und dem Trägheitsmoment wie folgt bestimmen:
