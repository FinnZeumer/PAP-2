...
\img{Tiefpass_s}{Der theoretische Tiefpassfilter. \cite{skriptPAP22}}
...
\img{Hochpass_s}{Der theoretische Hochpassfilter. \cite{skriptPAP22}}

\subsection{RC-Glied als Differenziator und Integrator}
\wrap[0.35]{R}{BSP_Integrator_s}{Beispielhafter Verlauf des RC-Gliedes als Integrator. \cite{skriptPAP22}}
...
\wrap[0.35]{L}{differentiator_s}{Beispielhafter Verlauf des RC-Gliedes als Differentiator. \cite{skriptPAP22}}
