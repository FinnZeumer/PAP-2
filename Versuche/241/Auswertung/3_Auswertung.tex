...
\label{sec:A1}
Ziel der ersten Aufgabe ist es die Zeitkonstante $\tau$ \com{Hier link zu Gl für zau} herauszufinden. Dazu wird der Versuchsaufbau \com{nach abb hier einfügen} mit verschiedenen Kombinationen aus Widerständen und Kondensatoren aufgebaut. Es wird zunächst die Spannung $U_C$ über den Kondensator abgegriffen. Die Halbwertszeit $T_{1/2}$ wurde über den Cursor gemessen. \com{Unegnauigkeit angeben}. Die gemessenen für die Halbwetszeit, sowie die genutzte Generatorfrequenz sind im \hyperref[ch:Protokoll]{Messprotokoll} der Tabelle M.1.1 aufgelistet. 
