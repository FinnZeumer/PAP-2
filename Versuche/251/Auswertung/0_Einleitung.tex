...
\wrap[0.45]{R}{BiPos}{Darstellung der Annährung der Binominalverteilung an die Possionverteilung. \cite{skriptPAP22}}
...
In der Physik ist es essenziell, zu Messgrößen eine Unsicherheit anzugeben. Es wird davon ausgegangen, dass die Messwerte nach einer bestimmten Wahrscheinlichkeitsverteilung um den wahren Wert schwanken. Als Fehler $\Delta a$ einer Messgröße $a$ wird die Standardabweichung $\sigma_a$ der zugrundeliegenden Verteilung angegeben. Da die zugrundeliegende Verteilung nicht bekannt ist, muss der Parameter $\sigma_a$ anhand der Messdaten abgeschätzt werden. Dies tut man normalerweise über die empirische Standardabweichung
\eq{empirical_std}{
