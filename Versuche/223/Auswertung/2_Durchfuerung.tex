...
Die Bildaufnahme erfolgt über das bereitgestellte Python-Messprogramm. Im \emph{Capture}-Modus wird jede Sekunde ein Bild aufgenommen, hier 150 Bilder. Die Position eines ausgewählten Partikels muss während der gesamten Messdauer im Bildausschnitt verbleiben; gegebenenfalls wird minimal nachfokussiert, ohne das Deckglas zu berühren.

Zur späteren Auswertung ist eine Kalibrierung des Abbildungsmaßstabs erforderlich. Dazu wird ein Objektmikrometer unter das Mikroskop gelegt und im \emph{Calibration}-Modus des Programms vermessen. Aus dem Abstand zweier Teilstriche wird der Maßstab in \(\mathrm{\mu m/pixel}\) bestimmt und im Programm gespeichert.
...
\img[0.4]{calibration}{Screenshot aus der Kalibrierung.}